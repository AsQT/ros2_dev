...
Nodes launched:
  ...
  3. yolo_json_to_object_detection_node — YOLO JSON -> object detection messages
  4. yolo_hough_yaw_estimator_node  — stable wood yaw from image edges
  5. pixel_to_base_mapper_node      — pixel + depth -> camera-frame pose
  6. vision_detection_marker_node    — RViz markers (optional)
        ...
        parameters=[
            {
                ...
                "publish_debug": True,
                "draw_yaw_arrow": True,
                "draw_label_background": False,
                "draw_expanded_roi": False,
                "draw_raw_contour": False,
                "draw_rotated_box": True,
                "draw_selected_yaw_line": True,
    ...
    mapper_node = Node(
        ...
        parameters=[
            mapper_param_file,
            {
                ...
                "yaw_match_max_center_dist_px": 60.0,
                "yaw_stale_timeout_sec": 0.7,

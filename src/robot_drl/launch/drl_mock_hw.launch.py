"""Launch MoveIt mock hardware stack plus DRL planner.
...
Usage:
    ...
    ros2 launch robot_drl drl_mock_hw.launch.py input_mode:=vision

    ros2 launch robot_drl drl_mock_hw.launch.py \
        auto_execute_after_plan:=true target_x:=0.450 target_y:=-0.100 target_z:=0.200
"""

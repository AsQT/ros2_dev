...
**Purpose:** High-level task executor for the robot using MoveIt 2 (C++). Provides a service-based interface to MoveIt, abstracting away trajectory planning and execution.

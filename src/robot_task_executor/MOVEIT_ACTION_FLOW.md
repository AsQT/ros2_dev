# robot_task_executor - MoveIt / Action Execution Flow
...
|---|---|---|---|---|
| /move_to_* và /move_cartesian_* | robot_task_executor_msgs/srv | Server | src/task_executor_node.cpp | Service MoveIt legacy |

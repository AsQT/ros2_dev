# robot_moveit - MoveIt / Action Execution Flow
...
|---|---|---|---|---|
| /move_action, /execute_trajectory | moveit_msgs actions | Server từ move_group | launch/moveit*.launch.py | MoveIt planning/execution runtime |

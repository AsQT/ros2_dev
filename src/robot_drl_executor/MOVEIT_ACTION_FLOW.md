# robot_drl_executor - MoveIt / Action Execution Flow
...
|---|---|---|---|---|
| /move_cartesian_pose_sequence | MoveCartesianPoseSequence.srv | Server | src/robot_drl_executor_node.cpp | Compute Cartesian path và execute qua MoveIt |

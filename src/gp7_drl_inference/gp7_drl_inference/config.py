"""Constants for the gp7_drl_inference ROS2 package.
...
# Topic subscriptions
TOPIC_TCP_POSE = "/yaskawa/gp7/tcp_pose"   # Real robot only (motoROS2)
TOPIC_TCP_TF_SOURCE = "base_link"            # Simulation & real: TF base → tool0
TOPIC_TCP_TF_TARGET = "tool0"
...
# Services
SERVICE_MOVE_TO_CARTESIAN = "/gp7_task_executor/move_to_cartesian_target"
...
# PyBullet places the table surface at z=0; the real TCP z (from /yaskawa/gp7/tcp_pose)
...
def load_env_config(env_config_path: Optional[str] = None) -> dict:
    ...
    if env_config_path is None:
        try:
            ...
            share = get_package_share_directory("gp7_drl_inference")
            candidates = [

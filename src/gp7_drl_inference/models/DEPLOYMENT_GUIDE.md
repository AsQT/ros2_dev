...
This guide explains how to deploy a trained DDPG/SAC/TD3 policy model to a real Yaskawa GP7 robot or to an inference-only environment. It covers everything from required files and dependencies to writing the control loop and understanding environment parameters.
...
**Path example:**
```
Data/Training/Environment_Default/DDPG/YASKAWA_GP7/run_20260508_100002/model/best_model.zip
```
...
```
Where `workspace_range ≈ 0.5` meters for the GP7.
...
# --- Create environment ---
env_id = "YaskawaGP7ReachPyBullet-Default-v0"   # or "Collision-Free"
env = gym.make(
    env_id,
    enable_gui=True,
...
# GP7 workspace bounds (approximate)
...
# Workspace range for normalization (GP7 approximate)
